...
public class MusicVideoInformation {
    ...
    public State addMusicVideo(String name, String singerId, String musicId, String classificationId, String level, String price, String activity, String available, String introduction, HttpServletRequest request) throws DataBaseException, IOException {
        return musicVideoInformationService.addMusicVideo(name, singerId, musicId, classificationId, level, price, activity, available, introduction, request);
    }
    ...
    public String showMusicVideo(String[] condition, @RequestParam(defaultValue = "1") Integer pageNum, Model model) throws ParseException {
     ...
     * 修改编辑MV信息，ajax
     */
    @RequestMapping(value = "/modifyEditMusicVideo")
    @ResponseBody
    public State modifyEditMusicVideo(String id, String name, String singerId, String musicId, String classificationId, String level, String price, String activity, String available) throws DataBaseException, IOException {
        return musicVideoInformationService.modifyEditMusicVideo(id, name, singerId, musicId, classificationId, level, price, activity, available);
    }
     ...
     * 修改更多MV信息，ajax
     */
    @RequestMapping(value = "/modifyMoreMusicVideo")
    @ResponseBody
    public State modifyMoreMusicVideo(String id, String introduction, boolean[] fileCheckbox, HttpServletRequest request) throws DataBaseException {
        return musicVideoInformationService.modifyMoreMusicVideo(id, introduction, fileCheckbox, request);
    }
